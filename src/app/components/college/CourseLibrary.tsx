...
export function CourseLibrary({ onBack }: CourseLibraryProps) {
  ...
  const categories = ['all', 'Programming', 'Mathematics', 'Networking', 'Web Development', 'Database', 'Systems', 'AI/ML', 'Security'];
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Professional courses for engineering students</p>
            </div>
          </div>
